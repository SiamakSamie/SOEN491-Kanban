                            ...
                            <div class="space-y-4">
                                ...
                                <vSelect :options="allKanbanUsers"
                                    ...
                                    <template slot="option" slot-scope="option">
                                        <avatar :name="option.user.name" :size="4" class="mr-3 m-1 float-left"></avatar>
                                        <p class="inline">{{ option.user.name }}</p>
                                    </template>
                                    ...
                                    <template v-for="(member, memberIndex) in filtered">
                                        <div :key="memberIndex"
                                            ...
                                            <div class="flex items-center">
                                                <avatar :name="member.employee.user.name" :size="6" class="mr-3"></avatar>
                                                <span class="py-2 mr-3 text-gray-600">{{member.employee.user.name}}</span>
                                            </div>
